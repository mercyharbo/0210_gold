...
const footerGroups = [
  {
    title: "Shop",
    links: ["New Arrivals", "Best Sellers", "All Collections", "Gift Cards"],
  },
  {
    title: "Customer Care",
    links: ["Shipping & Returns", "Order Tracking", "Size Guide", "FAQs"],
  },
  {
    title: "About",
    links: ["Our Story", "Quality", "Care Guide", "Terms & Conditions"],
  },
  {
    title: "Contact",
    links: ["Email Us", "Store Locations", "Client Services", "Social Media"],
  },
];
