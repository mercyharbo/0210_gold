      ...
      <section className='px-5 py-12 sm:px-8 lg:px-12'>
        <div className='mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1.15fr]'>
          ...
          <div className='space-y-6'>
            ...
            {/* Help Card */}
            <div className='border border-black/10 bg-neutral-50 p-6 text-black space-y-4 sm:p-8'>
              ...
              <div className='flex flex-wrap gap-3 pt-2'>
                ...
                <Link
                  href='/faq'
                  className='inline-flex h-10 items-center justify-center border border-black/20 px-5 text-xs font-semibold uppercase text-black transition-colors hover:bg-black hover:text-white'
                >
                  View FAQs
                </Link>
              </div>
          ...
          <div className='space-y-6'>
            {trackedOrder ? (
              <div className='space-y-6'>
                ...
                <div className='border border-black/10 p-6 sm:p-8 bg-neutral-50 text-black space-y-4'>
                  <div className='flex flex-wrap items-center justify-between gap-4 border-b border-black/10 pb-4'>
                    ...
                    <div className='text-right'>
                      <span className='text-xs text-muted-foreground block'>Date Placed</span>
                  ...
                  {isCancelled ? (
                    <div className='bg-rose-50 border border-rose-200 text-rose-700 px-4 py-3 text-xs font-semibold flex items-center gap-2'>
                      <XCircle className='size-4 text-rose-500' />
                      This order was marked as Cancelled. Please contact support for assistance.
                    </div>
                  ) : (
                    <div className='flex flex-wrap items-center justify-between gap-4 text-sm pt-1'>
                  ...
                  <div className='grid gap-4'>
                    {trackingSteps.map(({ key, stepNumber, title, description, Icon }, index) => {
                      ...
                      return (
                        <div
                          key={key}
                          className={`grid gap-5 border p-5 transition-all ${
                            isCurrent
                        ...
                        >
                          ...
                          <div className='space-y-1'>
                            <div className='flex items-center justify-between gap-2'>
                              ...
                              {isCompleted && (
                                <span
                                  className={`inline-flex items-center justify-center px-2.5 py-0.5 text-sm font-medium border ${
                                    isCurrent
                ...
                <div className='border border-black/10 p-6 sm:p-8 space-y-6 bg-white'>
              ...
              <div className='grid gap-4'>
                <div className='p-6 bg-neutral-50 border border-black/10 space-y-2'>
                  <p className='text-xs font-semibold uppercase text-gold'>
                    How Tracking Works
                  </p>
                ...
                {trackingSteps.map(({ stepNumber, title, description, Icon }) => (
                  <div
                    key={title}
                    className='grid gap-5 border border-black/10 p-6 sm:grid-cols-[auto_1fr] sm:items-start bg-white'
                  >
                    <div className='flex items-center gap-4'>
                      <span className='grid size-11 place-items-center bg-gold/20 text-black'>
