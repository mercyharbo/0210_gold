...
export default function AuthConfirmedPage() {
  return (
    <main className='min-h-dvh bg-[#f7f5f0] px-5 py-12 text-black sm:px-8 lg:px-12'>
      <div className='mx-auto flex min-h-[calc(100dvh-6rem)] max-w-3xl items-center justify-center'>
        <section className='w-full border border-black/10 bg-white p-6 text-center sm:p-10'>
          <div className='mx-auto mb-6 grid size-16 place-items-center bg-[#f3d77a]'>
          ...
          <p className='mx-auto mt-5 max-w-lg text-sm leading-6 text-black/62'>
          ...
          <div className='mt-8 flex flex-col justify-center gap-3 sm:flex-row'>
            <Link
              href='/login'
              className='inline-flex h-12 items-center justify-center gap-2 bg-black px-6 text-sm font-semibold text-white transition-colors hover:bg-[#b88a2b]'
            >
              Sign in
