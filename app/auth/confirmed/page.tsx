  ...
  return (
    <main className='min-h-dvh bg-muted px-5 py-12 text-black sm:px-8 lg:px-12'>
      <div className='mx-auto flex min-h-[calc(100dvh-6rem)] max-w-3xl items-center justify-center'>
        <section className='flex w-full flex-col items-center gap-8 border border-black/10 bg-white p-6 text-center sm:p-10'>
          <div className='grid size-16 place-items-center bg-gold/35'>
          ...
          <div className='space-y-5'>
            ...
            <h1 className='mx-auto max-w-xl font-heading text-5xl font-semibold leading-none sm:text-6xl'>
